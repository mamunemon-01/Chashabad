...
public class MainCarrotActivity extends AppCompatActivity{
    TextView titleText, seed_fig_name, seedling_fig_name, plant_fig_name, rootcut_fig_name, non_rootcut_fig_name, carrot_fig_name, guideText;
    //Button langBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carrot_main);
        ...
        plant_fig_name = (TextView) findViewById(R.id.plant_fig_name);
        rootcut_fig_name = (TextView) findViewById(R.id.rootcut_fig_name);
        non_rootcut_fig_name = (TextView) findViewById(R.id.non_rootcut_fig_name);
        carrot_fig_name = (TextView) findViewById(R.id.carrot_fig_name);
...
/*
        ...
        plant_fig_name.setText(resources.getString(R.string.title_activity_vine));
        rootcut_fig_name.setText(resources.getString(R.string.title_activity_flower));
        non_rootcut_fig_name.setText(resources.getString(R.string.title_activity_fruit));
        carrot_fig_name.setText(resources.getString(R.string.title_activity_tomato));
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainCarrotActivity.this, CarrotSeedActivity.class));
            }
        });
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainCarrotActivity.this, CarrotSeedlingActivity.class));
            }
        });
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainCarrotActivity.this, CarrotPlantActivity.class));
            }
        });
        ...
        btn4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainCarrotActivity.this, CarrotActivity.class));
            }
        });
        ...
        btn5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainCarrotActivity.this, CarrotRootcutActivity.class));
            }
        });
        ...
        btn6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainCarrotActivity.this, CarrotNonRootcutActivity.class));
            }
        });
